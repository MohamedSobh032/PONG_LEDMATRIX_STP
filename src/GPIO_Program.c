...
/*******************************************************************/
/* Func. Name: GPIO_voidTogglePinValue                             */
/* i/p arguments: Copy_u8PortId: IOA, IOB, IOC                     */
/* i/p arguments: Copy_u32Value: PIN0 --> PIN15                    */
/* o/p arguments: nothing                                          */
/* Desc. : This API allows user to toggle value of a specific port */ 
/*******************************************************************/
void GPIO_voidTogglePinValue(u8 Copy_u8PortId, u8 Copy_u8PinId)
{
    ...
    else
    {
        ...
        {
            case IOA: TOG_BIT(GPIOA->ODR, Copy_u8PinId);
                      break;
            case IOB: TOG_BIT(GPIOB->ODR, Copy_u8PinId);
                      break;
            case IOC: TOG_BIT(GPIOC->ODR, Copy_u8PinId);
                      break;
        }
    }
}
...
/* i/p arguments: Copy_u32Value: PIN0 --> PIN15                 */
/* o/p arguments: nothing                                       */
/* Desc. : This API allows user to set value of a specific port */ 
/****************************************************************/
...
/***************************************************************/
/* Func. Name: GPIO_voidGetPinValue                            */
/* i/p arguments: Copy_u8PortId: IOA, IOB, IOC                 */
/* i/p arguments: Copy_u8PinId: PIN0 --> PIN15                 */
/* o/p arguments: the value of a specific pin                  */
/* Desc. : This API allows user to get value of a specific pin */ 
/***************************************************************/
